...
properties = (
    ...
    .select("id, property_url, price, currently_live, listing_status")
...
with sync_playwright() as p:
    ...
    for prop in properties.data:
        ...
        old_currently_live = prop.get("currently_live")
        old_listing_status = prop.get("listing_status")
        ...
        try:
            ...
            if old_price is not None and new_price is not None and old_price != new_price:
                ...
                events_created += 1
                print(f"Event created: {event_type} {old_price} -> {new_price}")
